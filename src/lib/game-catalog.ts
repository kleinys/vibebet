...
export const GAME_CATALOG: GameDefinition[] = [
  ...
  },
  {
    ...
    kind: "luck",
    status: "live",
    description: "Drop the chip — land a multiplier slot. Low / medium / high risk.",
    href: "/games/arcade#plinko",
    flag: "arcade_games_enabled",
  },
  {
    key: "lucky_slots",
    ...
    kind: "luck",
    status: "live",
    description: "Spin three reels — line wins pay out. Triple SCRATCH wins a real scratcher ticket.",
    href: "/games/arcade#lucky-slots",
    flag: "arcade_games_enabled",
  },
  {
    key: "lightning_duel",
