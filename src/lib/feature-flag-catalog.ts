...
export const FEATURE_FLAG_CATALOG: FeatureFlagDefinition[] = [
  ...
  { key: "user_modules_enabled", description: "Platform Apps store at /apps — browse and install curated modules" },
  { key: "module_proposals_enabled", description: "User module proposals at /apps/create — moderation queue" },
  { key: "module_creation_enabled", description: "User-submitted modules — keep off until moderation pipeline ships" },
  { key: "arena_raid_enabled", description: "Communal arena raid events on Watch tab" },
