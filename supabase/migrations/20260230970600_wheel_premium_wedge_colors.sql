-- Wider visual wedges + matching odds for 500 / 1000 / 2500 jackpot tiers.
...
declare
  ...
  v_weights numeric[] := array[14, 8, 12, 5, 16, 6, 10, 4, 15, 7, 13, 2];
  v_total numeric := 0;
  v_pick numeric;
  v_i int;
begin
  ...
  if v_arch = 'arcane' then
    v_weights := array[0, 0, 0, 3, 0, 2, 0, 4, 0, 2, 0, 26];
  end if;
