...
export const WHEEL_SEGMENTS = [
  ...
  { label: "500 VIBE", color: "#f59e0b", text: "#fef3c7", weight: 2.5 },
  ...
  { label: "1000 VIBE", color: "#ef4444", text: "#fee2e2", weight: 1.5 },
  ...
  { label: "2500 JACKPOT", color: "#fbbf24", text: "#451a03", weight: 0.85 },
] as const;
