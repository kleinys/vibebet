...
export const PLAYER_PATHS: PlayerPathOption[] = [
  ...
  },
  {
    ...
    hubHref: "/live",
    createHref: "/live",
    onboardingBlurb: "Watch live streams, duels in progress, and auto-resolved Up/Down windows.",
    welcomeLine: "Streams, duels, and live price windows — watch and bet in one hub.",
    howItWorks: [
      "Hosted streams (YouTube/Twitch) appear in Watch hub with side markets.",
      "Active head-to-head duels show up for spectators to bet on.",
      "BTC, ETH, SOL windows auto-resolve — timers and spot prices update live.",
    ],
    firstActionLabel: "Open Watch hub",
    firstActionHref: "/live",
  },
  {
    id: "trainer",
